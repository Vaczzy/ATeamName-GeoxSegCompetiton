...
model = dict(
    ...
    decode_head=dict(
        ...
        loss_decode=dict(
            ...
            use_sigmoid=False,
            loss_weight=1.0,
            class_weight=[1.1, 1.1, 3, 1.5, 1.4, 1.5, 2.8, 2, 3])),
    auxiliary_head=dict(
        type='FCNHead',
        in_channels=1024,
        in_index=2,
        ...
        norm_cfg=dict(type='BN', requires_grad=True),
        align_corners=False,
        loss_decode=dict(type='DiceLoss', loss_weight=0.8)),
    train_cfg=dict(),
...
work_dir = './WorkSpace/zzy/data/SegCompetition_station/logs_myfitconfig_lovasz_weight'
gpu_ids = range(0, 1)
